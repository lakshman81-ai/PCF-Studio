...
const DrawCanvas_DrawCanvasControls = ({ orthoMode }) => {
...
export function DrawCanvasTab() {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-4rem)] w-full overflow-hidden bg-slate-950 rounded-lg shadow-inner relative mt-[-2rem]">
            ...
            {showGridSettings && (
                <div className="absolute top-12 right-14 z-50 bg-slate-800 border border-slate-700 rounded-lg p-4 shadow-2xl w-64">
                    <div className="flex justify-between items-center mb-3 border-b border-slate-700 pb-2">
                        <h3 className="text-sm font-bold text-slate-200">Draw Settings</h3>
                        <button onClick={() => setShowGridSettings(false)} className="text-slate-400 hover:text-white">✕</button>
                    </div>
            ...
            <div className="flex flex-1 overflow-hidden relative">
                ...
                <div className="flex-1 relative bg-slate-950">
                    ...
                    >
                        ...
                        <DrawCanvas_DrawCanvasControls orthoMode={localOrthoMode} />
