...
export function runStage4(components, injectedPipes, pipelineRef, logFn = () => {}) {
  ...
  function emitBridgeSplit(br, fromRefNo) {
    ...
    if (hits.length === 0) {
      ...
      outputLines.push(...emitPipe(br.ep1, br.ep2, br.bore, pipelineRef, seqCtr, cfg, ep1RefNo));
      return;
    }
    ...
    for (const hit of hits) {
      ...
      outputLines.push(...emitPipe(cursor, hit.snap, br.bore, pipelineRef, seqCtr, cfg, segRefNo));
    ...
    outputLines.push(...emitPipe(cursor, br.ep2, br.bore, pipelineRef, seqCtr, cfg, ep1RefNo));
  }
