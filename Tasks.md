...
[2026-04-03 20:23 UTC] [Task 52] ["[Task 52]" "Match valve weight by bore, rating, and length with ±6mm tolerance"] [Done] [js/services/weight-service.js, js/ui/status-bar.js] [Valve weight lookup now uses a ±6mm length window while keeping the bore and rating filters intact] [work] [N/A]
